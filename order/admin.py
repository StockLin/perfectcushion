...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('BILLING_INFORMATION', {'fields': ['emailAddress', 'billingName', 'billingAddress1', 'billingCity', 'billingPostcode', 'billingCountry']}),
        ('SHIPPING_INFORMATION', {'fields': ['shippingName', 'shippingAddress1', 'shippingCity', 'shippingPostcode', 'shippingCountry']}),
    ]
